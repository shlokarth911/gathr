  ...
  const features = [
    {
      ...
      description:
        "Browse through a diverse collection of venues tailored to your event needs. Filter by location, capacity, and amenities.",
    },
    {
      icon: <Calendar className="w-8 h-8" />,
      title: "Easy Booking System",
      description:
        "Request bookings instantly with our streamlined process. Specify your event details, date, time, and guest count.",
    },
    {
      icon: <Building2 className="w-8 h-8" />,
      title: "Venue Management",
      description:
        "For venue owners: List, manage, and update your properties with ease. Upload images, set pricing, and manage availability.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Secure Authentication",
      description:
        "Your data is protected with JWT-based authentication. Separate secure portals for attendees and venue owners.",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Sign up as an attendee looking for venues or as an owner to list your properties.",
    ...
    },
    {
      ...
      description:
        "Attendees can browse and filter venues. Owners can create detailed listings with images and amenities.",
    ...
    },
    {
      ...
      description:
        "Attendees send booking requests. Owners review and confirm bookings through their dashboard.",
    ...
    },
    {
      ...
      description:
        "Track bookings, update profiles, and manage all your event planning or venue operations in one place.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-white">Gathr</span>
            </div>
            <button
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            The ultimate platform connecting event planners with exceptional
            venues. Whether you're hosting or listing, we make venue booking
            effortless.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-[#1DB954] to-[#169c46] p-8 rounded-xl backdrop-blur-xl border border-[#1DB954]/30 hover:scale-105 transition-all duration-300">
            ...
            <p className="mb-6 text-gray-900 leading-relaxed">
              Planning an event? Find the perfect venue with all the amenities
              you need.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center text-black">
            <div className="group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-900">
                Find venues across various locations
              </p>
            </div>
            <div className="group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-900">
                Get responses to your requests fast
              </p>
            </div>
            <div className="group hover:scale-105 transition-transform duration-300">
